...
private final class LogSubscriber {
    ...
    init(webSocket: WebSocket, eventLoop: EventLoop, handler: @escaping (String) -> Void) {
...
final class LoggerService: Service {
    ...
    /// Подписаться
    func subscribe(_ webSocket: WebSocket, on eventLoop: EventLoop, subscriptionHandler handler: @escaping (String) -> Void) {
